    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/assets/images/property-01.jpg" alt="" /></a>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/assets/images/property-02.jpg" alt="" /></a>
            <span className="category">Luxury Villa</span>
            <h6>$1.180.000</h6>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/assets/images/property-03.jpg" alt="" /></a>
            <span className="category">Luxury Villa</span>
            <h6>$1.460.000</h6>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/assets/images/property-04.jpg" alt="" /></a>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <a href="property-details.html"><img src="assets/assets/images/property-05.jpg" alt="" /></a>
...
export default PropertiesSectionComponent