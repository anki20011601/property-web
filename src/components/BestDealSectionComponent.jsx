...
function BestDealSectionComponent() {
  return (
   <>
              ...
              <div className="tab-content" id="myTabContent">
                <div className="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <img src="assets/assets/images/deal-01.jpg" alt="" />
                    </div>
                    <div className="col-lg-3">
                ...
                <div className="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <img src="assets/assets/images/deal-02.jpg" alt="" />
                    </div>
                    <div className="col-lg-3">
                      <h4>Detail Info About Villa</h4>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, do eiusmod tempor pack incididunt ut labore et dolore magna aliqua quised ipsum suspendisse. <br /><br />Swag fanny pack lyft blog twee. JOMO ethical copper mug, succulents typewriter shaman DIY kitsch twee taiyaki fixie hella venmo after messenger poutine next level humblebr /ag swag franzen.</p>
                      <div className="icon-button">
                        <a href="property-details.html"><i className="fa fa-calendar"></i> Schedule a visit</a>
                      </div>
                    </div>
                ...
                <div className="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <img src="assets/assets/images/deal-03.jpg" alt="" />
                    </div>
                    <div className="col-lg-3">
...
export default BestDealSectionComponent